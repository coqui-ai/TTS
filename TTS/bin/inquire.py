...
def multispeaker_inquirer():
    multispeaker_questions = [
        ...
        inquirer.Text("speaker_idx", message="Enter speaker idx", default=None),
        inquirer.Text("language_idx", message="Enter language idx", default=None),
        inquirer.Text("speaker_wav", message="Enter speaker wav file path", default=None),
        inquirer.Text("reference_wav", message="Enter ref wav file path", default=None),
        inquirer.Text("reference_speaker_idx", message="Enter reference speaker idx", default=None),
    ]
...
def capacitron_inquirer():
    capacitron_questions = [
        inquirer.Text("capacitron_style_wav", message="Enter capacitron style wav path", default=None),
        inquirer.Text("capacitron_style_text", message="Enter capacitron style text", default=None),
    ]
...
def continue_inquirer():
    continue_questions = [
        inquirer.List(
            "to_do", message="What to do next?", choices=["try another text-input", "restart tts", "exit tts"]
        ),
    ]
...
def tts_inquirer(
    ...
    tts_questions = [
        ...
        inquirer.Text("out_path", message="Enter output wav path", default="tts_output.wav"),
    ]
...
def init_prompt():
    ...
    if init_answers["to_do"] == "play with official model zoo":
        ...
        vocoder_name = (
            answers_model_load["vocoder_choose"]
            if answers_model_load["vocoder_choose"] != "default_vocoder"
            else model_item["default_vocoder"]
        )
