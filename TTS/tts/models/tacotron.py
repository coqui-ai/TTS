...
class Tacotron(TacotronAbstract):
    ...
    def __init__(self,
        ...
        if self.capacitron and self.capacitron_use_speaker_embedding:
            self.decoder_in_features += capacitron_text_summary_embedding_dim # add capacitron text embedding dim
