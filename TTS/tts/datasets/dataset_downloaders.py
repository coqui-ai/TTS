...
class DatasetDownloaders:
    def __init__(
        ...
        self.dataset_dict = {
            ...
            "mailabs-german": ("https://data.solak.de/data/Training/stt_tts/de_DE.tgz", "de_DE.tgz", "MaiLabs-German"),
            "mailabs-french": ("https://data.solak.de/data/Training/stt_tts/fr_FR.tgz", "fr_FR.tgz", "MaiLabs-French"),
            "mailabs-italian": (
