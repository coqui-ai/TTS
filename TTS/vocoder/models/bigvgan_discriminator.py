...
class MultiPeriodDiscriminator(torch.nn.Module):
    def __init__(self, mpd_reshapes, discriminator_channel_mult=1, use_spectral_norm = False):
        ...
        discriminators = [DiscriminatorP(rs, discriminator_channel_mult= discriminator_channel_mult, 
        use_spectral_norm=use_spectral_norm) for rs in self.mpd_reshapes]
...
class DiscriminatorR(nn.Module):
    def __init__(self, discriminator_channel_mult=1,
...
class MultiResolutionDiscriminator(nn.Module):
    def __init__(self, discriminator_channel_mult=1,
        ...
        self.discriminators = nn.ModuleList(
            [DiscriminatorR(discriminator_channel_mult, use_spectral_norm, mrd_use_spectral_norm, 
            mrd_channel_mult, resolution) for resolution in self.resolutions]
        )
