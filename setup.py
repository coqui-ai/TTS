...
if LooseVersion(sys.version) < LooseVersion("3.6") or LooseVersion(sys.version) >= LooseVersion("3.11"):
    raise RuntimeError("TTS requires python > 3.5 and < 3.11 " "but your Python version is {}".format(sys.version))
