...
from TTS.enhancer.configs.hifigan_2_config import Hifigan2Config
...
config = Hifigan2Config(
    ...
    audio_augmentation={
        ...
        "EQ": {"min_snr_in_db": -12, "max_snr_in_db": 12, "p": 0.7},
        "gaussian": {"min_snr_in_db": 15, "max_snr_in_db": 45, "p": 0.5},
    },
)
