...
# Debug Diff Out
#import torch
#mels_in = torch.rand((32,512,80))
#b = model.style_encoder_layer.layer.forward(mels_in)
#print(b)

# Debug Model Out
#model.eval()
#a = model.forward(batch['text'], batch['text_lengths'], batch['mel'], batch['mel_lengths'])['style_encoder_outputs']
#print(a)