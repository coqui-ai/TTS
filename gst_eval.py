...
#%%
def tts(model, text, CONFIG, use_cuda, ap, style_wav, use_gl, speaker_id=None, figures=True):
    global runcounter
    t_1 = time.time()
    ...
    runcounter += 1
    waveform, alignment, decoder_output, postnet_output, stop_tokens, inputs = synthesis(model, text, CONFIG, use_cuda, ap, style_wav=style_wav, use_griffin_lim=use_gl, truncated=False)
...
# Set constants
ROOT_PATH = TTS_PATH
MODEL_PATH = os.path.join(r'/home/big-boy/Models/Blizzard/', 'blizzard-gts-March-17-2021_03+34PM-b4248b0', 'best_model.pth.tar')
CONFIG_PATH = os.path.join(r'/home/big-boy/Models/Blizzard/', 'blizzard-gts-March-17-2021_03+34PM-b4248b0', 'config.json')
OUT_FOLDER = os.path.join(ROOT_PATH, 'AudioSamples/benchmark_samples/')
STYLE_WAV_PATH = os.path.join(r'/home/big-boy/Data/blizzard2013/segmented/refs/refs_seen', 'BLZ000068.wav')
...
for sentence in sentences:
    ...
    alignment, postnet_output, stop_tokens, waveform = tts(model, sentence, CONFIG, use_cuda, ap, style_wav=STYLE_WAV_PATH, speaker_id=speaker_id, use_gl=use_gl, figures=True)

#%%
def plot_alignmentt(alignment,
                    info=None,
                    fig_size=(16, 10),
                    title=None,
                    output_fig=False):
